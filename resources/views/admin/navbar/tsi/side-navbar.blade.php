        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{ url('/tsi/user')}}" class="nav-link @if($class==='User') active @endif"><i class="far fa-user nav-icon"></i> Users</a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('/tsi/dokter')}}" class="nav-link @if($class==='dokter') active @endif"><i class="far fa-circle nav-icon"></i> Dokter</a>
                </li>
                <li class="nav-item">
