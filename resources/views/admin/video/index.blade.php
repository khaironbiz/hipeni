                                                ...
                                                <form action="{{route('admin.video.store')}}" method="post">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row mb-2">
                                                            ...
                                                            <small>https://www.youtube.com/watch?v=<b class="text-danger">92Rjzrq4oIg</b></small>
                                                        </div>
                                                    </div>
                                ...
                                <table class="table table-sm table-striped">
                                    ...
                                    @foreach($videos as $data)
                                        <tr>
                                            ...
                                            <td><a href="{{route('admin.video.show', ['slug'=>$data->slug])}}" class="btn btn-sm btn-success">Detail</a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
