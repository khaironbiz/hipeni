                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                                ...
                                <button type="button" class="btn btn-primary btn-sm mb-2" data-toggle="modal" data-target="#staticBackdrop">
                                    Tambah
                                </button>
                                ...
                                <div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('question.store', ['slug' => $training->slug]) }}" method="post">
                                                @csrf
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select name="answer_type_id" class="form-control">
                                                                <option value="">-----</option>
                                                                @foreach($answer_type_id as $row)
                                                                <option value="{{$row->id}}">{{$row->nama_jawaban}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
